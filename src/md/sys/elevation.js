...
export const elevation = css `
  :host {
    ...
    --md-sys-elevation0: ${s("--md-sys-elevation-level0")} ${color.shadow.light(0.0)};
    --md-sys-elevation1: ${s("--md-sys-elevation-level1")} ${color.shadow.light(0.1)};
    --md-sys-elevation2: ${s("--md-sys-elevation-level2")} ${color.shadow.light(0.2)};
    --md-sys-elevation3: ${s("--md-sys-elevation-level3")} ${color.shadow.light(0.3)};
    --md-sys-elevation4: ${s("--md-sys-elevation-level4")} ${color.shadow.light(0.4)};
    --md-sys-elevation5: ${s("--md-sys-elevation-level5")} ${color.shadow.light(0.5)};
  }
`;
