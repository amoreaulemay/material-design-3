...
let MdcFilledTonalButton = class MdcFilledTonalButton extends MdcBaseButton {
};
MdcFilledTonalButton.styles = [
    ...styles.base,
    styles.button,
    css `
          button {
...
MdcFilledTonalButton = __decorate([
    customElement("mdc-filled-tonal-button")
], MdcFilledTonalButton);
export { MdcFilledTonalButton };
